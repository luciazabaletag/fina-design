    ...
    <main className='max-w-screen-xl px-6 mt-20 mx-auto'>
        ...
        <div className="grid grid-rows-1 auto-rows-fr md:grid-rows-none md:grid-cols-3 gap-4 md:w-5/6 mx-auto">
                ...
                <div className='relative'>
                    ...
                    <img className=" h-full max-w-full rounded-lg" src="src/assets/img/chairr.jpg" alt="imagen silla"/>
                </div>
                ...
                <div className=' md:row-span-2  relative'>
                    ...
                    <img className="h-full object-cover max-w-full rounded-lg" src="src/assets/img/livingg.jpg" alt="imagen living"/>
                </div>
                <div className='relative'>
                    ...
                    <img className="h-full object-cover max-w-full rounded-lg" src="src/assets/img/sofaa.jpg" alt="imagen sofa"/>
                </div>
                ...
                <div className=' relative'>
                    ...
                    <img className="h-full object-cover max-w-full rounded-lg" src="src/assets/img/lucess.jpg" alt="imagen luz"/>
                </div>
                ...
                <div className='md:col-auto relative'>
                    ...
                    <img className="h-full object-cover w-full rounded-lg" src="src/assets/img/accesorioss.jpg" alt="imagen accesorios"/>
                </div>
        </div>
